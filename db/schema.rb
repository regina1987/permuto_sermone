...
ActiveRecord::Schema.define(version: 2020_03_11_010240) do
  ...
  create_table "idiomas_users", id: false, force: :cascade do |t|
    t.bigint "idioma_id", null: false
    t.bigint "user_id", null: false
    t.index ["idioma_id", "user_id"], name: "index_idiomas_users_on_idioma_id_and_user_id"
